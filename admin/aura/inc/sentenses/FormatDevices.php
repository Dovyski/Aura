...
function formatDevices($theGroupName) {
	...
	if($aHowManyDevices > 0) {
		$aCommand = array(
			'win' 	=> 'sed "s/.*set default=\"[0-9]\".*/   set default=\"3\"/" o:\boot\grub\grub.cfg > o:\boot\grub\grub.cfg.tmp & cat o:\boot\grub\grub.cfg.tmp > o:\boot\grub\grub.cfg & shutdown -r -t 60 & msg * "O computador vai ser formatado em 1 minuto. Salve tudo aberto agora!"',
